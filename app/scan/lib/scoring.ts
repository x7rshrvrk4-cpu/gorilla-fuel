...
const ADDITIVES: AdditiveEntry[] = [
  ...
  },
  {
    ...
    risk: "low",
    penalty: 0,
    note: "Enzyme processing aid used to break down proteins (e.g. dough conditioning, protein hydrolysis). A processing aid, not a hazard; noted for label transparency only.",
    tier: "precautionary",
    healthBodyPosition: "Food-grade proteases (protein-digesting enzymes) are Generally Recognized As Safe by the FDA and permitted by the EFSA as processing aids. They are typically deactivated during processing and pose no recognized health concern at food-additive levels.",
    gorillaPosition: "A processing enzyme, not a health concern — about as benign as additives get. Listed purely so the detected-additives list is complete for people who want to see every additive present.",
    sources: ["FDA — Enzyme Preparations Used in Food (21 CFR 184)", "EFSA — Food Enzymes safety evaluations"],
    matchers: [{ label: "Proteases", pattern: /\bproteases?\b/i }],
  },
  {
    id: "potassium-chloride",
    risk: "low",
    penalty: 0,
    note: "A salt substitute used to reduce sodium — the potassium analogue of table salt. GRAS; noted for label transparency only.",
    tier: "precautionary",
    healthBodyPosition: "Potassium chloride (E508) is Generally Recognized As Safe by the FDA and approved by the EFSA. It is widely used to cut sodium content, and dietary potassium is generally beneficial — no health concern at food-additive levels for the general population (those on potassium-restricted diets should note its presence).",
    gorillaPosition: "A sodium-reducing salt substitute — usually a good sign, since it means less sodium. Listed for transparency/completeness only, never deducted.",
    sources: ["FDA Code of Federal Regulations — 21 CFR 184.1622", "EFSA — Potassium chloride (E508) evaluation"],
    matchers: [name("Potassium chloride"), ecode("E508")],
  },
  {
    ...
    matchers: [name("Sodium phosphates"), name("Sodium phosphate"), name("Disodium phosphate"), name("Trisodium phosphate"), name("Dipotassium phosphate"), name("Monopotassium phosphate"), name("Monocalcium phosphate"), name("Sodium hexametaphosphate"), name("Tetrasodium pyrophosphate"), ecode("E339"), ecode("E340"), ecode("E341")],
  },
  {
