...
export type AlcoholRankingProduct = {
  ...
  /** Wine only — subcategory for filtering (Red, White, Rosé, Sparkling, Sweet). */
  wineSubcategory?: WineSubcategory;
  /** Wine only — grape variety or blend name. */
  varietal?: string;
  /** Wine only — producing region (country / appellation). */
  region?: string;
};
...
export const ALCOHOL_PRODUCTS: AlcoholRankingProduct[] = [
  ...
  // Style: Dry < 4g sugar · Semi-Dry 4–8g · Sweet > 8g per 148mL pour.
  ...
  },
  {
    ...
    varietal: "Red Blend",
    region: "California, USA",
    brand: "Ménage à Trois",
    name: "Ménage à Trois Red",
    abv: 13.5,
    caloriesPerCan: 153,
    carbsPerCan: 5.8,
    sugarPerCan: 3.2,
  ...
  },
  {
    ...
    category: "Wines",
    wineSubcategory: "Sparkling",
    varietal: "Cava (Macabeo, Xarel·lo, Parellada)",
    region: "Penedès, Spain (DO Cava)",
    brand: "Freixenet",
